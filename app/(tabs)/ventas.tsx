...
export default function HomeScreen() {
 const { busqueda, loading, filteredProducts, ventaActual, isSearchFocused, handleQuantityChange, handleVendido, setbusqueda, setIsSearchFocused, agregarProductoAVenta } = useVentas();
